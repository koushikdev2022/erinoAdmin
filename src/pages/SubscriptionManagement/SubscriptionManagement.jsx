...
const SubscriptionManagement = () => {
  ...
  console.log("subscriptionList 123", subscriptionList);
  ...
  const rowData = useMemo(() => {
    ...
    if (!subscriptionList?.data || !Array.isArray(subscriptionList.data)) {
      console.log("No plan badge data available or invalid format");
      return [];
    }

    // Fixed: Use planBadgeList.data directly
    return subscriptionList.data.map((mar) => ({
